...
router.get("/new", middleware.isRachel, function (req, res) {
...
router.get("/:id", function (req, res) {
    ...
    Campground.findById(req.params.id).populate({ path: 'foods', populate: { path: 'comments' }}).exec(function (err, foundCampground) {
        if (err) {
            console.log(err);
        } else {
